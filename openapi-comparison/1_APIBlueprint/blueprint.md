...
### Books Collection (array[Book])

### Error (object)

* **error** (string) - Thông báo lỗi
* **status** (number) - HTTP status code
* **details** (array[string], optional) - Chi tiết lỗi
...
* Parameters
  ...
  * skip: 0 (number, optional) - Số sách bỏ qua (pagination)
  * limit: 10 (number, optional) - Số sách trả về (mặc định 10, tối thiểu 1)
  * sort_by: `created_at` (string, optional) - Sắp xếp theo trường
...
* Response 200 (application/json)
  ...
  * Attributes (object)
    ...
    * total: 25 (number) - Tổng số sách (integer)
    * skip: 0 (number)
    * limit: 10 (number)
